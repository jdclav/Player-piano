...
class Arrow:
    ...
    choice: list[Union[ArrowDirection, ArrowStyle, Empty, CircularArrow]] = (
        field(
    ...
    choice: list[
        ...
        metadata={
            ...
            "choices": (
                {
                    "name": "p",
                    "type": ForwardRef("Dynamics.P"),
                },
                {
                    "name": "pp",
                    "type": ForwardRef("Dynamics.Pp"),
                },
                {
                    "name": "ppp",
                    "type": ForwardRef("Dynamics.Ppp"),
                },
                {
                    "name": "pppp",
                    "type": ForwardRef("Dynamics.Pppp"),
                },
                {
                    "name": "ppppp",
                    "type": ForwardRef("Dynamics.Ppppp"),
                },
                {
                    "name": "pppppp",
                    "type": ForwardRef("Dynamics.Pppppp"),
                },
                {
                    "name": "f",
                    "type": ForwardRef("Dynamics.F"),
                },
                {
                    "name": "ff",
                    "type": ForwardRef("Dynamics.Ff"),
                },
                {
                    "name": "fff",
                    "type": ForwardRef("Dynamics.Fff"),
                },
                {
                    "name": "ffff",
                    "type": ForwardRef("Dynamics.Ffff"),
                },
                {
                    "name": "fffff",
                    "type": ForwardRef("Dynamics.Fffff"),
                },
                {
                    "name": "ffffff",
                    "type": ForwardRef("Dynamics.Ffffff"),
                },
                {
                    "name": "mp",
                    "type": ForwardRef("Dynamics.Mp"),
                },
                {
                    "name": "mf",
                    "type": ForwardRef("Dynamics.Mf"),
                },
                {
                    "name": "sf",
                    "type": ForwardRef("Dynamics.Sf"),
                },
                {
                    "name": "sfp",
                    "type": ForwardRef("Dynamics.Sfp"),
                },
                {
                    "name": "sfpp",
                    "type": ForwardRef("Dynamics.Sfpp"),
                },
                {
                    "name": "fp",
                    "type": ForwardRef("Dynamics.Fp"),
                },
                {
                    "name": "rf",
                    "type": ForwardRef("Dynamics.Rf"),
                },
                {
                    "name": "rfz",
                    "type": ForwardRef("Dynamics.Rfz"),
                },
                {
                    "name": "sfz",
                    "type": ForwardRef("Dynamics.Sfz"),
                },
                {
                    "name": "sffz",
                    "type": ForwardRef("Dynamics.Sffz"),
                },
                {
                    "name": "fz",
                    "type": ForwardRef("Dynamics.Fz"),
                },
                {
                    "name": "n",
                    "type": ForwardRef("Dynamics.N"),
                },
                {
                    "name": "pf",
                    "type": ForwardRef("Dynamics.Pf"),
                },
                {
                    "name": "sfzp",
                    "type": ForwardRef("Dynamics.Sfzp"),
                },
                {
                    "name": "other-dynamics",
                    "type": OtherText,
...
class Harmonic:
    ...
    natural_or_artificial: Optional[
        Union["Harmonic.Natural", "Harmonic.Artificial"]
    ] = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
                {
                    "name": "natural",
                    "type": ForwardRef("Harmonic.Natural"),
                },
                {
                    "name": "artificial",
                    "type": ForwardRef("Harmonic.Artificial"),
                },
            ),
        },
    )
    base_pitch_or_touching_pitch_or_sounding_pitch: Optional[
        Union[
            "Harmonic.BasePitch",
        ...
        metadata={
            ...
            "choices": (
                {
                    "name": "base-pitch",
                    "type": ForwardRef("Harmonic.BasePitch"),
                },
                {
                    "name": "touching-pitch",
                    "type": ForwardRef("Harmonic.TouchingPitch"),
                },
                {
                    "name": "sounding-pitch",
                    "type": ForwardRef("Harmonic.SoundingPitch"),
                },
            ),
        },
    )
...
class InstrumentChange:
    ...
    solo_or_ensemble: Optional[
        Union[Empty, Union[int, PositiveIntegerOrEmptyValue]]
    ] = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
                ...
                {
                    "name": "ensemble",
                    "type": Union[int, PositiveIntegerOrEmptyValue],
                },
            ),
        },
    )
...
class Play:
    ...
    choice: list[Union[str, Mute, SemiPitched, OtherPlay]] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
...
class Swing:
    ...
    choice: list[
        Union[Empty, "Swing.First", "Swing.Second", SwingTypeValue]
    ] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
                ...
                {
                    "name": "first",
                    "type": ForwardRef("Swing.First"),
                },
                {
                    "name": "second",
                    "type": ForwardRef("Swing.Second"),
                },
                {
                    "name": "swing-type",
                    "type": SwingTypeValue,
...
class Bend:
    ...
    pre_bend_or_release: Optional[Union[Empty, Release]] = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
...
class Credit:
    ...
    choice: list[
        Union[Link, Bookmark, Image, FormattedTextId, FormattedSymbolId]
    ] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
                ...
                {
                    "name": "credit-words",
                    "type": FormattedTextId,
                },
                {
                    "name": "credit-symbol",
                    "type": FormattedSymbolId,
                },
            ),
        },
    )
    ...
    choice: list[
        ...
        metadata={
            ...
            "choices": (
                {
                    "name": "encoding-date",
                    "type": ForwardRef("Encoding.EncodingDate"),
                },
                {
                    "name": "encoder",
                    "type": TypedText,
                ...
                {
                    "name": "software",
                    "type": ForwardRef("Encoding.Software"),
                },
                {
                    "name": "encoding-description",
                    "type": ForwardRef("Encoding.EncodingDescription"),
                },
                {
                    "name": "supports",
                    "type": Supports,
...
class Key:
    ...
    choice: list[Union[Cancel, int, str, Step, Decimal, KeyAccidental]] = (
        field(
            default_factory=list,
            metadata={
                "type": "Elements",
...
class Listen:
    ...
    assess_or_wait_or_other_listen: list[
        Union[Assess, Wait, OtherListening]
    ] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
...
class Listening:
    ...
    sync_or_other_listening: list[Union[Sync, OtherListening]] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
...
class Lyric:
    ...
    :ivar syllabic_or_text_or_elision:
    :ivar extend:
    :ivar laughing_or_humming:
    ...
    syllabic_or_text_or_elision: list[
        Union[Syllabic, TextElementData, Elision]
    ] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
    ...
    laughing_or_humming: Optional[Union["Lyric.Laughing", "Lyric.Humming"]] = (
        field(
            default=None,
            metadata={
                "type": "Elements",
                "choices": (
                    {
                        "name": "laughing",
                        "type": ForwardRef("Lyric.Laughing"),
                    },
                    {
                        "name": "humming",
                        "type": ForwardRef("Lyric.Humming"),
                    },
                ),
            },
        )
...
class MeasureStyle:
    ...
    choice: Optional[Union[MultipleRest, MeasureRepeat, BeatRepeat, Slash]] = (
        field(
            default=None,
            metadata={
                "type": "Elements",
...
class NameDisplay:
    ...
    display_text_or_accidental_text: list[
        Union[FormattedText, AccidentalText]
    ] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
...
class Time:
    ...
    choice: list[
        Union[
            "Time.Beats", "Time.BeatType", Interchangeable, "Time.SenzaMisura"
        ]
    ] = field(
        default_factory=list,
        metadata={
            ...
            "choices": (
                {
                    "name": "beats",
                    "type": ForwardRef("Time.Beats"),
                },
                {
                    "name": "beat-type",
                    "type": ForwardRef("Time.BeatType"),
                },
                {
                    "name": "interchangeable",
                ...
                {
                    "name": "senza-misura",
                    "type": ForwardRef("Time.SenzaMisura"),
                },
            ),
        },
    )
...
class Articulations:
    ...
    choice: list[
        Union[
            ...
            BreathMark,
            Caesura,
            "Articulations.Stress",
            "Articulations.Unstress",
            "Articulations.SoftAccent",
            OtherPlacementText,
        ]
    ] = field(
        default_factory=list,
        metadata={
            ...
            "choices": (
                {
                    "name": "accent",
                    "type": ForwardRef("Articulations.Accent"),
                },
                {
                    "name": "strong-accent",
                    "type": StrongAccent,
                ...
                {
                    "name": "staccato",
                    "type": ForwardRef("Articulations.Staccato"),
                },
                {
                    "name": "tenuto",
                    "type": ForwardRef("Articulations.Tenuto"),
                },
                {
                    "name": "detached-legato",
                    "type": ForwardRef("Articulations.DetachedLegato"),
                },
                {
                    "name": "staccatissimo",
                    "type": ForwardRef("Articulations.Staccatissimo"),
                },
                {
                    "name": "spiccato",
                    "type": ForwardRef("Articulations.Spiccato"),
                },
                {
                    "name": "scoop",
                    "type": ForwardRef("Articulations.Scoop"),
                },
                {
                    "name": "plop",
                    "type": ForwardRef("Articulations.Plop"),
                },
                {
                    "name": "doit",
                    "type": ForwardRef("Articulations.Doit"),
                },
                {
                    "name": "falloff",
                    "type": ForwardRef("Articulations.Falloff"),
                },
                {
                    "name": "breath-mark",
                    "type": BreathMark,
                ...
                {
                    "name": "stress",
                    "type": ForwardRef("Articulations.Stress"),
                },
                {
                    "name": "unstress",
                    "type": ForwardRef("Articulations.Unstress"),
                },
                {
                    "name": "soft-accent",
                    "type": ForwardRef("Articulations.SoftAccent"),
                },
                {
                    "name": "other-articulation",
                    "type": OtherPlacementText,
                },
            ),
        },
    )
    ...
    @dataclass
    class Scoop(EmptyLine):
        pass

    @dataclass
    class Plop(EmptyLine):
        pass

    @dataclass
    class Doit(EmptyLine):
        pass

    @dataclass
    class Falloff(EmptyLine):
        pass
...
class Ornaments:
    ...
    choice: list[
        Union[
            "Ornaments.TrillMark",
            "Ornaments.Turn",
            "Ornaments.DelayedTurn",
            "Ornaments.InvertedTurn",
            "Ornaments.DelayedInvertedTurn",
            "Ornaments.VerticalTurn",
            "Ornaments.InvertedVerticalTurn",
            "Ornaments.Shake",
            WavyLine,
            "Ornaments.Mordent",
            "Ornaments.InvertedMordent",
            EmptyPlacement,
            Tremolo,
            "Ornaments.Haydn",
            OtherPlacementText,
        ...
        metadata={
            ...
            "choices": (
                {
                    "name": "trill-mark",
                    "type": ForwardRef("Ornaments.TrillMark"),
                },
                {
                    "name": "turn",
                    "type": ForwardRef("Ornaments.Turn"),
                },
                {
                    "name": "delayed-turn",
                    "type": ForwardRef("Ornaments.DelayedTurn"),
                },
                {
                    "name": "inverted-turn",
                    "type": ForwardRef("Ornaments.InvertedTurn"),
                },
                {
                    "name": "delayed-inverted-turn",
                    "type": ForwardRef("Ornaments.DelayedInvertedTurn"),
                },
                {
                    "name": "vertical-turn",
                    "type": ForwardRef("Ornaments.VerticalTurn"),
                },
                {
                    "name": "inverted-vertical-turn",
                    "type": ForwardRef("Ornaments.InvertedVerticalTurn"),
                },
                {
                    "name": "shake",
                    "type": ForwardRef("Ornaments.Shake"),
                },
                {
                    "name": "wavy-line",
                    "type": WavyLine,
                ...
                {
                    "name": "mordent",
                    "type": ForwardRef("Ornaments.Mordent"),
                },
                {
                    "name": "inverted-mordent",
                    "type": ForwardRef("Ornaments.InvertedMordent"),
                },
                {
                    "name": "schleifer",
                    "type": EmptyPlacement,
                ...
                {
                    "name": "haydn",
                    "type": ForwardRef("Ornaments.Haydn"),
                },
                {
                    "name": "other-ornament",
                    "type": OtherPlacementText,
    ...
    @dataclass
    class TrillMark(EmptyTrillSound):
        pass

    @dataclass
    class Turn(HorizontalTurn):
        pass

    @dataclass
    class DelayedTurn(HorizontalTurn):
        pass

    @dataclass
    class InvertedTurn(HorizontalTurn):
        pass

    @dataclass
    class DelayedInvertedTurn(HorizontalTurn):
        pass

    @dataclass
    class VerticalTurn(EmptyTrillSound):
        pass

    @dataclass
    class InvertedVerticalTurn(EmptyTrillSound):
        pass

    @dataclass
    class Shake(EmptyTrillSound):
        pass
    ...
    @dataclass
    class InvertedMordent(Mordent):
        pass

    @dataclass
    class Haydn(EmptyTrillSound):
        pass
...
class Technical:
    ...
    choice: list[
        ...
        metadata={
            ...
            "choices": (
                {
                    "name": "up-bow",
                    "type": ForwardRef("Technical.UpBow"),
                },
                {
                    "name": "down-bow",
                    "type": ForwardRef("Technical.DownBow"),
                },
                {
                    "name": "harmonic",
                    "type": Harmonic,
                ...
                {
                    "name": "open-string",
                    "type": ForwardRef("Technical.OpenString"),
                },
                {
                    "name": "thumb-position",
                    "type": ForwardRef("Technical.ThumbPosition"),
                },
                {
                    "name": "fingering",
                    "type": Fingering,
                ...
                {
                    "name": "double-tongue",
                    "type": ForwardRef("Technical.DoubleTongue"),
                },
                {
                    "name": "triple-tongue",
                    "type": ForwardRef("Technical.TripleTongue"),
                },
                {
                    "name": "stopped",
                    "type": ForwardRef("Technical.Stopped"),
                },
                {
                    "name": "snap-pizzicato",
                    "type": ForwardRef("Technical.SnapPizzicato"),
                },
                {
                    "name": "fret",
                    "type": Fret,
                ...
                {
                    "name": "hammer-on",
                    "type": ForwardRef("Technical.HammerOn"),
                },
                {
                    "name": "pull-off",
                    "type": ForwardRef("Technical.PullOff"),
                },
                {
                    "name": "bend",
                    "type": Bend,
                ...
                {
                    "name": "heel",
                    "type": ForwardRef("Technical.Heel"),
                },
                {
                    "name": "toe",
                    "type": ForwardRef("Technical.Toe"),
                },
                {
                    "name": "fingernails",
                    "type": ForwardRef("Technical.Fingernails"),
                },
                {
                    "name": "hole",
                    "type": Hole,
                ...
                {
                    "name": "brass-bend",
                    "type": ForwardRef("Technical.BrassBend"),
                },
                {
                    "name": "flip",
                    "type": ForwardRef("Technical.Flip"),
                },
                {
                    "name": "smear",
                    "type": ForwardRef("Technical.Smear"),
                },
                {
                    "name": "open",
                    "type": ForwardRef("Technical.Open"),
                },
                {
                    "name": "half-muted",
                    "type": ForwardRef("Technical.HalfMuted"),
                },
                {
                    "name": "harmon-mute",
                    "type": HarmonMute,
                ...
                {
                    "name": "golpe",
                    "type": ForwardRef("Technical.Golpe"),
                },
                {
    ...
    @dataclass
    class Stopped(EmptyPlacementSmufl):
        pass
    ...
    @dataclass
    class HammerOn(HammerOnPullOff):
        pass

    @dataclass
    class PullOff(HammerOnPullOff):
        pass
    ...
    @dataclass
    class Open(EmptyPlacementSmufl):
        pass

    @dataclass
    class HalfMuted(EmptyPlacementSmufl):
        pass
...
class Attributes:
    ...
    transpose_or_for_part: list[Union[Transpose, ForPart]] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
...
class Harmony:
    ...
    :ivar root_or_numeral_or_function:
    :ivar kind:
    :ivar inversion:
    :ivar bass:
    :ivar degree:
    ...
    root_or_numeral_or_function: list[Union[Root, Numeral, StyleText]] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
...
class Metronome:
    ...
    :ivar metronome_note_or_metronome_relation:
    :ivar default_x:
    :ivar default_y:
    :ivar relative_x:
    :ivar relative_y:
    ...
    choice: list[Union[NoteTypeValue, Empty, BeatUnitTied, PerMinute]] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
    ...
    metronome_note_or_metronome_relation: list[Union[MetronomeNote, str]] = (
        field(
            default_factory=list,
            metadata={
                "type": "Elements",
...
class DirectionType:
    ...
    choice: list[
        ...
        metadata={
            ...
            "choices": (
                {
                    "name": "rehearsal",
                    "type": ForwardRef("DirectionType.Rehearsal"),
                },
                {
                    "name": "segno",
                    "type": Segno,
                ...
                {
                    "name": "words",
                    "type": ForwardRef("DirectionType.Words"),
                },
                {
                    "name": "symbol",
                    "type": FormattedSymbolId,
                ...
                {
                    "name": "damp",
                    "type": ForwardRef("DirectionType.Damp"),
                },
                {
                    "name": "damp-all",
                    "type": ForwardRef("DirectionType.DampAll"),
                },
                {
                    "name": "eyeglasses",
                    "type": ForwardRef("DirectionType.Eyeglasses"),
                },
                {
                    "name": "string-mute",
                    "type": StringMute,
    ...
    @dataclass
    class Rehearsal(FormattedTextId):
        pass

    @dataclass
    class Words(FormattedTextId):
        pass
...
class Note:
    ...
    choice: list[
        Union["Note.Chord", Pitch, Unpitched, Rest, Tie, "Note.Cue", Decimal]
    ] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
...
class PartList:
    ...
    part_group_or_score_part: list[Union[PartGroup, ScorePart]] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
